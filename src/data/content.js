export const NAV_LINKS = [
  { name: 'Trabalho', path: '/portfolio' },
  { name: 'Serviços', path: '/services' },
  { name: 'Método', path: '#metodo' },
  { name: 'Sobre', path: '/about' },
  { name: 'Futuros', path: '/futuros' },
  { name: 'Clientes', path: '#clientes' },
];

export const HERO_CONTENT = {
  headline: 'Visão e Design que\nConsolidam Valor',
  subheadline:
    'Um estúdio de design contemporâneo dedicado à estratégia e à criação de identidades de marca. Trabalhamos com empresas e visionários para construir marcas consistentes, relevantes e duradouras.',
};
...
export const ABOUT_CONTENT = {
  philosophy:
    'Criamos identidades e sistemas visuais que conectam pensamento estratégico, design contemporâneo e construção de marca.',
  focus:
    'Working globally from our studio, we partner with founders and institutions who value precision, clarity, and enduring quality.',
};

export const CONTACT_INFO = {
  email: 'hello@studiodesign.com',
  instagram: '@studiodesign',
  linkedin: 'Studio Design',
  address: '100 Contemporary Ave, Design District',
};
