          ...
          <div className="md:col-span-12 lg:col-span-5 pt-8 lg:pt-0">
            <form className="flex flex-col gap-10 bg-surface p-8 md:p-12 lg:p-16 rounded shadow-lg border border-borderline/30" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="flex flex-col gap-2 group">
                <label htmlFor="name" className="text-overline font-medium text-secondary group-focus-within:text-accent uppercase tracking-widest transition-colors">Name</label>
                <input 
                  type="text" 
                  id="name" 
              ...
              <div className="flex flex-col gap-2 group">
                <label htmlFor="email" className="text-overline font-medium text-secondary group-focus-within:text-accent uppercase tracking-widest transition-colors">Email</label>
                <input 
                  type="email" 
                  id="email" 
                  className="bg-transparent border-b border-borderline focus:border-accent focus:outline-none py-3 transition-colors text-lg placeholder-muted/50 text-primary font-normal"
              ...
              <div className="flex flex-col gap-2 group">
                <label htmlFor="message" className="text-overline font-medium text-secondary group-focus-within:text-accent uppercase tracking-widest transition-colors">Message</label>
                <textarea 
                  id="message" 
                  rows="4"
